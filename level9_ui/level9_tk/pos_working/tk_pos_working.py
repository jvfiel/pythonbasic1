from Tkinter import *
from fill_in_listbox import fill

food = [
    {"item":"apple","price":5},
    {"item":"banana","price":8},
    {"item":"potato","price":10}
]
...
class ListBoxChoice(object):
    ...
    def _choose(self, event=None):
        try:
            ...
            self.value = self.list[int(firstIndex)]['item']
        except IndexError:
            self.value = None
...
if __name__ == '__main__':
    ...
    while returnValue:
        returnValue = ListBoxChoice(root, "Food", "Pick one of these",
                                    list).returnValue()
        print returnValue